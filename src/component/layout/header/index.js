...
import Menuicon from "../../../assets/images/manu.svg";
import { Navigation, Pagination, Scrollbar, A11y } from "swiper";
import { Swiper, SwiperSlide } from "swiper/react";
import Golfing from "../../../assets/images/round-icon.jpg";
import Boats from "../../../assets/images/boats.jpg";
import Camping from "../../../assets/images/comping.jpg";
import Containericon from "../../../assets/images/container.jpg";
import Desert from "../../../assets/images/desert.jpg";
import Mensssions from "../../../assets/images/mesions.jpg";
import Offthegrid from "../../../assets/images/offthe grid.jpg";
import Raids from "../../../assets/images/raids.jpg";
...
const Header = () => {
  ...
  return (
    <>
      <div className="block md:hidden w-full mx-auto fixed top-0 z-[999999999] bg-white">
        <div className="mt-6 mx-8 header-search border-gray-200 rounded-full border border-opacity-80 flex items-center py-2 px-4 justify-between">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex text-[12px] text-gray-500">
              <p>Anywhere</p>
              <span className="px-2">.</span> <p>Any week</p>
              <span className="px-2">.</span> <p>Add guest</p>
            </div>
          </div>
          <div className="border-[1px] rounded-full border-gray-300 py-3 px-3 flex justify-center items-center">
        ...
        <div className="">
          <div className="flex justify-between container mx-auto items-center">
            <div className="header-swiper container mx-auto py-6 flex w-[90%]">
              <Swiper
                className="mx-20"
              ...
              >
                <SwiperSlide>
                  <div className="flex flex-col items-center cursor-pointer border-b-[2px] border-black">
                    <img className="w-[25px] h-[25px]" src={Golfing} />
                    <p className="text-sm mt-2 text-black hover:text-black hover:border-b-[2px] pb-2 hover:border-gray-400">
                      Golfing
                    </p>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div className="flex flex-col items-center cursor-pointer">
                    <img className="w-[25px] h-[25px]" src={Boats} />
                    <p className="text-sm mt-2 text-gray-600 border-b-[2px] border-white hover:text-black hover:border-b-[2px] pb-2 hover:border-gray-400">
                      Boats
                    </p>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div className="flex flex-col items-center cursor-pointer">
                    <img className="w-[25px] h-[25px]" src={Camping} />
                    <p className="text-sm mt-2 text-gray-600 border-b-[2px] border-white hover:text-black hover:border-b-[2px] pb-2 hover:border-gray-400">
                      Camping
                    </p>
                  </div>
                ...
                <SwiperSlide>
                  <div className="flex flex-col items-center cursor-pointer">
                    <img className="w-[25px] h-[25px]" src={Containericon} />
                    <p className="text-sm mt-2 text-gray-600 border-b-[2px] border-white hover:text-black hover:border-b-[2px] pb-2 hover:border-gray-400">
                      Container
                    </p>
                  </div>
                ...
                <SwiperSlide>
                  <div className="flex flex-col items-center cursor-pointer">
                    <img className="w-[25px] h-[25px]" src={Desert} />
                    <p className="text-sm mt-2 text-gray-600 border-b-[2px] border-white hover:text-black hover:border-b-[2px] pb-2 hover:border-gray-400">
                      Desert
                    </p>
                  </div>
                ...
                <SwiperSlide>
                  <div className="flex flex-col items-center cursor-pointer">
                    <img className="w-[25px] h-[25px]" src={Mensssions} />
                    <p className="text-sm mt-2 text-gray-600 border-b-[2px] border-white hover:text-black hover:border-b-[2px] pb-2 hover:border-gray-400">
                      Mensssions
                    </p>
                  </div>
                ...
                <SwiperSlide>
                  <div className="flex flex-col items-center cursor-pointer">
                    <img className="w-[25px] h-[25px]" src={Offthegrid} />
                    <p className="text-sm mt-2 text-gray-600 border-b-[2px] border-white hover:text-black hover:border-b-[2px] pb-2 hover:border-gray-400">
                      Off The Grid
                    </p>
                  </div>
                ...
                <SwiperSlide>
                  <div className="flex flex-col items-center cursor-pointer">
                    <img className="w-[25px] h-[25px]" src={Raids} />
                    <p className="text-sm mt-2 text-gray-600 border-b-[2px] border-white hover:text-black hover:border-b-[2px] pb-2 hover:border-gray-400">
                      Raids
                    </p>
                  </div>
                ...
                <SwiperSlide>
                  <div className="flex flex-col items-center cursor-pointer">
                    <img className="w-[25px] h-[25px]" src={Tower} />
                    <p className="text-sm mt-2 text-gray-600 border-b-[2px] border-white hover:text-black hover:border-b-[2px] pb-2 hover:border-gray-400">
                      Tower
                    </p>
                  </div>
      ...
      <div className="fixed top-0 w-full z-[999999999] bg-white hidden md:block ">
        <div className="container mx-auto py-6 ">
          <div className="header-main flex justify-between md:px-4 lg:px-10 xl:px-0">
            <div className="Logo">
              <div class="l10sdlqs dir dir-ltr text-[#ff385c]">
            ...
            <div className="header-search border-gray-200 rounded-full border border-opacity-80 flex items-center px-2">
              <form>
                <div class="flex items-center">
                  <div className="flex">
                    <p className="font-[500] text-[14px] border-r-2 px-4 cursor-pointer">
                      Anywhere
                    </p>
                    <p className="font-[500] text-[14px] border-r-2 px-4 cursor-pointer">
                      Any week
                  ...
                  <div class="relative">
                    <input
                      type="search"
                      id="search-dropdown"
                      class="block p-2.5 z-20 text-sm outline-none w-[140px] rounded-full"
                      placeholder="Add guests"
                      required
                    />
                    <button
                      type="submit"
                      class="absolute top-[3px] right-0 p-2 text-sm font-medium text-white bg-[#ff385c] rounded-full border "
                    >
                      <svg
                        aria-hidden="true"
                        class="w-4 h-4"
            ...
            <div className="header-user-profile flex items-center">
              <button className="font-[500] text-[14px] py-3 px-4 mr-2 hover:bg-[#f7f7f7] rounded-full">
                Become a Host
              </button>
              <div className="global-icon w-[20px] h-[20px]">
                <img src={World} />
              </div>
              ...
              <div
                ...
                className="relative header-search ml-6 cursor-pointer border-gray-200 rounded-full border border-opacity-80 flex items-center px-2 py-[5px]"
              >
                <img className="w-[25px] h-[25px] mr-3" src={Menuicon} />
                <div>
                  <svg
                ...
                {popup && (
                  <div className="z-[99999999999999999] userProfile bg-white py-4 absolute w-[250px] drop-shadow top-[60px] right-0 rounded-xl">
                    <div className="">
                      <p className="font-[500] text-[14px] py-3 hover:bg-[#f7f7f7] px-4 flex items-center">
                        Sign up
                      </p>
                      <p className="text-[14px] py-3 hover:bg-[#f7f7f7] px-4 flex items-center">
                        Login
                      </p>
                    </div>
                    <div className="border-t-[1px] border-gray-300 my-3"></div>
                    <div className="">
                      <p className=" text-[14px] py-3 hover:bg-[#f7f7f7] px-4 flex items-center">
                        Host Your Home
                      </p>
        ...
        <div className="border-t-[1px] border-gray-300">
          <div className="flex justify-between container mx-auto items-center md:px-4 lg:px-10 xl:px-0">
            <div className="header-swiper container mx-auto py-10 flex w-[90%]">
              <Swiper
                className="mx-20"
                // install Swiper modules
                modules={[Navigation, A11y]}
            ...
            <div className="border-[1px] rounded-lg border-gray-300 py-3 px-4 h-[45px]">
              <button className="w-[60px] flex items-center">
                <svg
                  className="text-black"
                  viewBox="0 0 16 16"
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="ml-2 font-[500] text-[14px]">Filters</p>
              </button>
            </div>
          </div>
        </div>
